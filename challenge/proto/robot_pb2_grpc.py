...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in proto/robot_pb2_grpc.py depends on'
...
class RobotServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetRobotData = channel.unary_unary(
                '/RobotService/GetRobotData',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=proto_dot_robot__pb2.RobotData.FromString,
...
def add_RobotServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetRobotData': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=proto_dot_robot__pb2.RobotData.SerializeToString,
            ),
    }
...
class RobotService(object):
    ...
    def GetRobotData(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            proto_dot_robot__pb2.RobotData.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
